...
public class CalculatorSteps {
    ...
    public void i_add(Integer int1) {
        log.debug("Adding number {} to last",int1);
        calc.push(int1);
        calc.push("+");
    }
    ...
    public void the_result_is_infinity(String arg1) {
        Number vaNumber = calc.value();
        log.debug("Result: {} (expected {})",vaNumber,arg1);
        assertEquals(vaNumber, Double.POSITIVE_INFINITY);
    }
